              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form method="POST" action="<?= base_url('admin/coordenadores/inserir')?>" class="needs-validation" novalidate="">
                      ...
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <select class="form-control selectric" name="categoria">
                      ...
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <textarea class="summernote-simple" name="descricao" rows="4" cols="50"></textarea>
                        </div>
                      </div>
		      <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Lattes</label>
                        <div class="col-sm-12 col-md-7">
